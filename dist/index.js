...
wall.use(function (wallEvent, next) {
    debugLogger(wallEvent);
    next();
});
...
wall.use(function (wallEvent, next) { return __awaiter(void 0, void 0, void 0, function () {
    var ids, resultEvent;
        ...
        if (!wallEvent.options.isTest) {
            ...
            Promise.all(resultEvent)
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    img.src = wallEvent.options.origin + "/data.gif?d=" + encodeURIComponent(JSON.stringify(wallEvent));
                });
            })
                .then(function (result) {
